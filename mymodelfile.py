#mymodelfile.py  —  IPL Powerplay Score Predictor  
...
#  REGIME DEFINITIONS
REGIME_LOW       = 0   # powerplay score < 44  
REGIME_NORMAL    = 1   # 44 ≤ score < 65       
REGIME_EXPLOSIVE = 2   # score ≥ 65           
...
# ═══════════════════════════════════════════════════════════════════════════
    ...
    def _build_stats(self, pp_df: pd.DataFrame, pp_scores: pd.DataFrame,
        ...
        rec    = pp_scores[pp_scores["season_year"] >= max_yr - 2].copy()  
        if not rec.empty:
